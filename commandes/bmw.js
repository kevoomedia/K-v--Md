...
france({ nomCom: "këvøø", reaction: "😜", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
async function  execute  (origineMessage,zok) {
  console.log("Commande saisie !!!s")
   let z ='Salut je m\'appelle *Këvøø😜-MD-REPO* \n\n '+'je suis un bot Whatsapp Multi-appareil '
      let d =' developpé par *Këvøøø😜-MD-REPO*'
      let varmess=z+d
